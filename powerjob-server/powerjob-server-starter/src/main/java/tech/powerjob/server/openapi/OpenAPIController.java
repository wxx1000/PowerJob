...
public class OpenAPIController {
    ...
    public ResultDTO<Long> assertAppName(@RequestParam("appName") String appName, @RequestParam(required = false, name = "password") String password) {
    ...
    public ResultDTO<Long> copyJob(@RequestParam("jobId") Long jobId) {
        return ResultDTO.success(jobService.copyJob(jobId).getId());
    }

    @PostMapping(OpenAPIConstant.EXPORT_JOB)
    public ResultDTO<SaveJobInfoRequest> exportJob(@RequestParam("jobId") Long jobId, @RequestParam("appId") Long appId) {
        checkJobIdValid(jobId, appId);
        return ResultDTO.success(jobService.exportJob(jobId));
    }

    @PostMapping(OpenAPIConstant.FETCH_JOB)
    public ResultDTO<JobInfoDTO> fetchJob(@RequestParam("jobId") Long jobId, @RequestParam("appId") Long appId) {
        checkJobIdValid(jobId, appId);
    ...
    public ResultDTO<Void> deleteJob(@RequestParam("jobId") Long jobId, @RequestParam("appId") Long appId) {
        checkJobIdValid(jobId, appId);
    ...
    public ResultDTO<Void> disableJob(@RequestParam("jobId") Long jobId, @RequestParam("appId") Long appId) {
        checkJobIdValid(jobId, appId);
    ...
    public ResultDTO<Void> enableJob(@RequestParam("jobId") Long jobId, @RequestParam("appId") Long appId) {
        checkJobIdValid(jobId, appId);
    ...
    public ResultDTO<Long> runJob(@RequestParam("appId") Long appId,
                                  @RequestParam("jobId") Long jobId,
                                  @RequestParam(required = false, name = "instanceParams") String instanceParams,
                                  @RequestParam(required = false, name = "delay") Long delay
    ) {
    ...
    public ResultDTO<Void> stopInstance(@RequestParam("instanceId") Long instanceId, @RequestParam("appId") Long appId) {
    ...
    public ResultDTO<Void> cancelInstance(@RequestParam("instanceId") Long instanceId, @RequestParam("appId") Long appId) {
        checkInstanceIdValid(instanceId, appId);
    ...
    public ResultDTO<Void> retryInstance(@RequestParam("instanceId") Long instanceId, @RequestParam("appId") Long appId) {
        checkInstanceIdValid(instanceId, appId);
    ...
    public ResultDTO<Integer> fetchInstanceStatus(@RequestParam("instanceId") Long instanceId) {
    ...
    public ResultDTO<InstanceInfoDTO> fetchInstanceInfo(@RequestParam("instanceId") Long instanceId) {
    ...
    public ResultDTO<Long> copy(@RequestParam("workflowId") Long workflowId, @RequestParam("appId") Long appId) {
        return ResultDTO.success(workflowService.copyWorkflow(workflowId, appId));
    }


    @PostMapping(OpenAPIConstant.FETCH_WORKFLOW)
    public ResultDTO<WorkflowInfoVO> fetchWorkflow(@RequestParam("workflowId") Long workflowId, @RequestParam("appId") Long appId) {
    ...
    public ResultDTO<Void> deleteWorkflow(@RequestParam("workflowId") Long workflowId, @RequestParam("appId") Long appId) {
        workflowService.deleteWorkflow(workflowId, appId);
        return ResultDTO.success(null);
    }

    @PostMapping(OpenAPIConstant.DISABLE_WORKFLOW)
    public ResultDTO<Void> disableWorkflow(@RequestParam("workflowId") Long workflowId, @RequestParam("appId") Long appId) {
        workflowService.disableWorkflow(workflowId, appId);
        return ResultDTO.success(null);
    }

    @PostMapping(OpenAPIConstant.ENABLE_WORKFLOW)
    public ResultDTO<Void> enableWorkflow(@RequestParam("workflowId") Long workflowId, @RequestParam("appId") Long appId) {
        workflowService.enableWorkflow(workflowId, appId);
        return ResultDTO.success(null);
    }

    @PostMapping(OpenAPIConstant.RUN_WORKFLOW)
    public ResultDTO<Long> runWorkflow(@RequestParam("workflowId") Long workflowId,
                                       @RequestParam("appId") Long appId,
                                       @RequestParam(required = false, name = "initParams") String initParams,
                                       @RequestParam(required = false, name = "delay") Long delay
    ) {
    ...
    public ResultDTO<Void> stopWorkflowInstance(@RequestParam("wfInstanceId") Long wfInstanceId, @RequestParam("appId") Long appId) {
    ...
    public ResultDTO<Void> retryWorkflowInstance(@RequestParam("wfInstanceId") Long wfInstanceId, @RequestParam("appId") Long appId) {
    ...
    public ResultDTO<Void> markWorkflowNodeAsSuccess(@RequestParam("wfInstanceId") Long wfInstanceId,
