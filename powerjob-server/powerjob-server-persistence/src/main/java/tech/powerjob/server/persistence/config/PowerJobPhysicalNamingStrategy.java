 ...
 * 参考实现：{@link org.hibernate.boot.model.naming.PhysicalNamingStrategyStandardImpl}
 * <p>
 ...
 * @since 2020/7/18
 */
public class PowerJobPhysicalNamingStrategy extends PhysicalNamingStrategySnakeCaseImpl implements Serializable {
    ...
    public Identifier toPhysicalTableName(Identifier name, JdbcEnvironment jdbcEnvironment) {
        ...
        String noDOText = Strings.CI.endsWith(text, "do") ? text.substring(0, text.length() - 2) : text;
